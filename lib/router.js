...
assetsRoutes.route('/', {
  action: function() {
    BlazeLayout.render("layout", {content: "assetsPage", header: "header1", footer: "footer1"})
  },
...
assetsRoutes.route('/create-location', {
  action: function() {
    BlazeLayout.render("layout", {content: "createLocationPage", header: "header1", footer: "footer1"})
  },
  triggersEnter: [function(context, redirect) {
...
assetsRoutes.route('/create-asset', {
  action: function() {
    BlazeLayout.render("layout", {content: "createAssetPage", header: "header1", footer: "footer1"})
  },
  triggersEnter: [function(context, redirect) {
...
assetsRoutes.route('/edit-location', {
  action: function() {
    BlazeLayout.render("layout", {content: "editLocationPage", header: "header1", footer: "footer1"})
  },
  triggersEnter: [function(context, redirect) {
...
assetsRoutes.route('/view-locations', {
  action: function() {
    BlazeLayout.render("layout", {content: "viewLocationsPage", header: "header1", footer: "footer1"})
  },
  triggersEnter: [function(context, redirect) {
